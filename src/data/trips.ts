          ...
          },
          {
            ...
            content: [
              ...
              },
              {
                type: 'text',
                title: 'The Product',
                text: 'PacaPlate helps people plan meals, generate grocery lists, and get recipe ideas without turning food into another high-friction productivity chore.',
              },
              {
                type: 'text',
                title: 'My Role',
                text: 'Designed the product concept, mascot-led experience, AI recipe workflows, and lightweight planning flow from idea to shipped web app.',
              },
              {
                type: 'text',
                title: 'Why It Works',
                text: 'The mascot gives the app emotional warmth while the AI handles the practical work: turning preferences, pantry context, and weekly routines into usable meal options.',
              },
              {
                type: 'metrics',
                title: 'Focus',
                items: [
                  { label: 'Product Type', value: 'AI app' },
                  { label: 'Experience', value: 'Mascot-led' },
                  { label: 'Workflow', value: 'Meals → lists' },
              ...
              },
              {
                ...
                title: 'What I Built',
                items: [
                  'AI-assisted recipe and meal planning flows.',
                  'Grocery list generation from selected meals.',
                  'A friendly alpaca companion to make planning feel lighter.',
                  'A live product experience that shows product taste, systems thinking, and playful UX.',
                ],
              },
              {
                type: 'links',
